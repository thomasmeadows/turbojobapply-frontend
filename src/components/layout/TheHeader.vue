    ...
    >
      <div class="space-y-1 pb-3 pt-2">
        <router-link
          ...
          :class="[$route.path === '/search' ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-transparent text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700']"
          @click="closeMobileMenu"
        >
          Find Jobs
        </router-link>
        <router-link
          to="/pricing"
          class="block border-l-4 py-2 pl-3 pr-4 text-base font-medium transition-colors duration-200"
          :class="[$route.path === '/pricing' ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-transparent text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700']"
          @click="closeMobileMenu"
        >
          Pricing
        </router-link>
        <router-link
          to="/about"
          class="block border-l-4 py-2 pl-3 pr-4 text-base font-medium transition-colors duration-200"
          :class="[$route.path === '/about' ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-transparent text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700']"
          @click="closeMobileMenu"
        >
          About
        </router-link>
