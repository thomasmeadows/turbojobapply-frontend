      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        ...
        <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-sm font-semibold text-gray-200 tracking-wider uppercase">For Job Seekers</h3>
              <ul class="mt-4 space-y-4">
                <li>
                  <router-link to="/search" class="text-base text-gray-300 hover:text-white">
                    Browse Jobs
                  </router-link>
                </li>
                <li>
