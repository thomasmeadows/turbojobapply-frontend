<template>
  <div>
    <div class="mb-8">
      ...
      <p class="mt-2 text-base text-gray-600">Your personal contact details for this job profile.</p>
    </div>
...
class="mb-2 block text-sm font-semibold text-gray-800"> Phone Number </label>
      ...
      <div class="border-t border-gray-200 pt-8">
        <h3 class="mb-6 text-lg font-semibold text-gray-900">Optional Information</h3>
        <p class="mb-6 text-sm text-gray-600">This information is optional but may be required by some employers</p>
