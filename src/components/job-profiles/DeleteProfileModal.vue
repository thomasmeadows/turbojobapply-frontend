...
/>
        ...
        <h3 class="mt-2 text-lg font-medium text-gray-900">Delete Job Profile</h3>
        ...
        <div class="mt-2 px-7 py-3">
          ...
          <div v-if="profile"
class="mb-3 rounded-md bg-gray-50 p-3 text-left">
            <h4 class="mb-2 text-xs font-medium text-gray-700">This will permanently delete:</h4>
            <ul class="space-y-1 text-xs text-gray-600">
              <li class="flex items-center">
                <svg class="mr-2 size-3 text-gray-400"
...
/>
              ...
              <li v-if="profile.skills && profile.skills.length > 0"
...
/>
              ...
              <li v-if="profile.experience && profile.experience.length > 0"
class="flex items-center">
                <svg class="mr-2 size-3 text-gray-400"
fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd"
...
/>
              ...
              <li v-if="profile.has_cover_letter"
class="flex items-center">
                <svg class="mr-2 size-3 text-gray-400"
fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd"
...
/>
          ...
          <p class="text-xs font-medium text-red-600">This action cannot be undone.</p>
        </div>
