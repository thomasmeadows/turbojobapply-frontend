  ...
  <div>
    <div class="mb-8">
      ...
      <p class="mt-2 text-base text-gray-600">
        Your job preferences and professional information for this profile.
      </p>
    </div>
    ...
    <div class="space-y-8">
      <!-- Date Available -->
      <div>
        <label for="date-available" class="block text-sm font-semibold text-gray-800 mb-2">
          Date Available
        </label>
        <input
          id="date-available"
      ...
      <!-- Desired Pay -->
      <div>
        <label for="desired-pay" class="block text-sm font-semibold text-gray-800 mb-2">
          Desired Pay
        </label>
        <input
          id="desired-pay"
      ...
      <div>
        <label for="linkedin-url" class="block text-sm font-semibold text-gray-800 mb-2">
          LinkedIn Profile URL
        </label>
        <div class="flex rounded-lg shadow-sm">
          <span class="inline-flex items-center px-4 py-3 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-gray-600 text-base font-medium">
            https://
          </span>
          <input
            id="linkedin-url"
            v-model="linkedinUrl"
            type="text"
            class="flex-1 block w-full px-4 py-3 rounded-none rounded-r-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base transition-colors"
      ...
      <div>
        <label for="website-url" class="block text-sm font-semibold text-gray-800 mb-2">
          Website, Blog, or Portfolio URL
        </label>
        <div class="flex rounded-lg shadow-sm">
          <span class="inline-flex items-center px-4 py-3 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-gray-600 text-base font-medium">
      ...
      <div class="border-t border-gray-200 pt-8">
        ...
        <p class="text-sm text-gray-600 mb-6">Upload your resume and cover letter to include with applications</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div v-if="!localProfile.has_resume" class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 cursor-pointer">
              ...
              <div class="flex items-center">
                ...
                <div class="ml-4 flex space-x-3">
                  <button
                    ...
                    class="px-3 py-1 text-green-700 hover:text-green-900 hover:bg-green-100 text-sm font-medium rounded-md transition-colors"
                  >
                    Download
                  </button>
                  <button
                    @click="removeResume"
                    class="px-3 py-1 text-red-600 hover:text-red-800 hover:bg-red-100 text-sm font-medium rounded-md transition-colors"
                  >
                    Remove
                  </button>
                </div>
          ...
          <div>
            ...
            <div v-if="!localProfile.has_cover_letter" class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 cursor-pointer">
              <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <div class="mt-4">
