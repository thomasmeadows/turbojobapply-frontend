  ...
  <div>
    <div class="mb-8">
      ...
      <p class="mt-2 text-base text-gray-600">
        Add up to 10 work experience entries. Include your most recent and
        relevant positions.
      </p>
    </div>
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <p class="text-xs text-amber-700">
              You have reached the maximum of 10 experience entries. Remove some
              to add new ones.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center space-x-3">
              <span
                class="inline-flex size-8 items-center justify-center rounded-full bg-blue-100 text-sm font-semibold text-blue-800"
              >
                {{ index + 1 }}
              </span>
              <h4 class="text-lg font-semibold text-gray-900">
                {{ exp.job_title || 'New Experience' }}
                <span v-if="exp.company_name" class="font-normal text-gray-600"
                  >at {{ exp.company_name }}</span
                >
              </h4>
            </div>
              ...
              <div class="space-y-3">
                ...
                <label class="inline-flex items-center">
                  <input
                    ...
                    type="checkbox"
                    class="size-4 rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200/50"
                    @change="handleCurrentJobChange(exp)"
                  />
                  <span class="ml-3 text-sm text-gray-700"
                    >This is my current job</span
                  >
                </label>
              </div>
            </div>
          ...
          <div>
            <label
              ...
              class="mb-3 block text-sm font-semibold text-gray-800"
            >
              Description
            </label>
            <QuillEditor
              ...
              @update:model-value="handleDescriptionUpdate(exp, $event)"
            />
            <p class="mt-2 text-sm text-gray-500">
              Use bullet points to highlight key achievements and
              responsibilities. Content auto-saves as you type.
            </p>
          </div>
        </div>
      </div>
...
const initialExperience = (localProfile.value.experience || []).map(
  (exp: any) => ({
    ...exp,
