...
class="py-4 text-center">
          <svg class="mx-auto size-8 animate-spin text-primary-500"
...
class="py-6 text-center">
          <svg class="mx-auto mb-4 size-12 text-gray-400"
fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
class="inline-flex items-center rounded-md border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700" @click="closeModal"
>
Create Job Profile
</router-link>
        </div>
...
>
              ...
              <option v-for="profile in jobProfilesStore.profiles"
...
Cancel
        ...
        <button :disabled="validating || loading"
class="rounded-md border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50" @click="submit"
>
          Continue
        </button>
      </div>
