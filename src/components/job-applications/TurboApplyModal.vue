...
import { JobProfileFieldType } from '@/stores/jobProfiles';
  ...
  (newFields) => {
    if (newFields && newFields.length > 0) {
      try {
        ...
        // fails when window closed and reopens
      }
    } else {
...
<template>
  ...
  >
    ...
    >
              ...
              <div class="space-y-4">
                ...
                >
                  <label class="block text-sm font-medium text-gray-700">
                    {{ field.question || getFieldLabel(field.name) }}
            ...
            <div v-if="customFields.length > 0">
              ...
              <div class="space-y-4">
                <div
                  ...
                  class="space-y-2"
                >
                  <!-- Show label for non-checkbox fields -->
                  <label
                  ...
                  <!-- Select dropdown for custom questions -->
                  <select
                  ...
                  >
                    <input
                      ...
                      :checked="
                        customQuestions[field.name] === true ||
                        customQuestions[field.name] === 'true'
                      "
                      :class="[
                        'rounded border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-500',
                        fieldErrors[field.name]
                          ? 'border-red-300 focus:border-red-500'
                          : 'border-gray-300'
                      ]"
                    ...
                    <label
                      ...
                      class="cursor-pointer text-sm text-gray-900"
                    >
                      {{ field.question || field.name }}
                      <span class="text-red-500">*</span>
                    </label>
      ...
      <div
        v-if="hasProfiles"
        class="flex shrink-0 justify-end space-x-3 border-t border-gray-200 px-6 py-4"
      >
        <button
        ...
        <button
          ...
          :disabled="!canSave || validating || saving || loading"
