...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="mb-6 flex items-center justify-between">
      ...
      <button v-if="bookmarkedJobs.length > 0" class="text-sm font-medium text-red-600 hover:text-red-700"
...
/>
      ...
      <p class="mb-4 text-gray-600">When you find a job that interests you, click the bookmark icon to save it for later.
</p>
      <router-link
to="/search" class="btn-primary"> Browse Jobs </router-link>
    ...
    <div v-else>
      <p class="mb-4 text-gray-600">You have bookmarked {{ bookmarkedJobs.length }} job{{ bookmarkedJobs.length !== 1 ? 's' : '' }}
</p>

      <div class="space-y-4">
        <div v-for="bookmark in bookmarkedJobs" :key="bookmark.bookmark_id"
          ...
          <div class="flex flex-col justify-between sm:flex-row sm:items-start">
            <div class="flex-1">
              <div class="mb-2 flex items-start justify-between">
                <div>
                  <router-link :to="getJobUrl(bookmark)"
class="mb-1 block">
...
/>
                  ...
                  <span class="text-gray-500">Bookmarked
                    {{
