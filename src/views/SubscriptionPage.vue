...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <p class="mb-6 text-gray-600">Unlock advanced features to supercharge your job search</p>
      ...
      <div class="p-6">
        ...
        <div v-else-if="isPremium || isSubscriptionActive">
          ...
          <div class="border-t border-gray-200 pt-6">
            <h3 class="mb-4 text-lg font-medium text-gray-900">Your Premium Benefits</h3>
              ...
              <div class="mb-6 rounded-md bg-gray-50 p-4">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Monthly subscription with advanced features</p>
                  </div>
        ...
        <div v-else>
          <h3 class="mb-4 text-lg font-medium text-gray-900">Upgrade to Premium</h3>
