          ...
          <div class="p-6">
            ...
            <div class="flex items-center">
              <div class="flex size-10 shrink-0 items-center justify-center rounded-full bg-primary-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-primary-600"
...
/>
                ...
                <div>
                  <p class="text-sm text-gray-700"><span class="font-medium">Premium Member</span> - You have access to all premium features including fast-track applications, enhanced profile visibility, and priority support.
</p>
            ...
            <div v-else
class="mt-6 rounded-md bg-accent-50 p-4">
              <div class="flex items-start">
...
/>
                ...
                <div>
                  <p class="text-sm text-gray-700"><span class="font-medium">Upgrade to Premium</span> for $10/month to access fast-track applications and enhanced profile visibility.
</p>
...
View all
            ...
            <div v-if="loading || jobsStore.bookmarksLoading"
class="flex justify-center py-10">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-6 animate-spin text-primary-500"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                <path stroke-linecap="round" stroke-linejoin="round"
...
/>
            ...
            <div v-else-if="bookmarkedJobs.length === 0"
class="py-10 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-2 size-8 text-gray-400"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                <path stroke-linecap="round" stroke-linejoin="round"
...
Start exploring jobs
            ...
            <div v-else
class="space-y-4">
              <div v-for="bookmark in bookmarkedJobs.slice(0, 3)" :key="bookmark.bookmark_id"
class="rounded-md border border-gray-200 p-4 transition-colors duration-200 hover:bg-gray-50"
>
                <div class="flex justify-between">
                  <div>
                    <a :href="bookmark.external_url" target="_blank"
class="text-base font-medium text-gray-900 hover:text-primary-600"
>
                      {{ bookmark.title }}
                    </a>
                    <p class="text-sm text-gray-600">{{ bookmark.company_name }} • {{ bookmark.location || 'Remote' }}
</p>
                    <div class="mt-1 flex items-center">
                      ...
                      <span v-if="bookmark.remote"
class="ml-2 inline-flex items-center rounded bg-green-100 px-2 py-0.5 text-xs font-medium text-green-800"
> Remote </span>
                    </div>
                  </div>
                  <div class="text-right text-xs text-gray-500">
                    <div>Bookmarked {{ formatDistanceToNow(parseISO(bookmark.bookmarked_at), { addSuffix: true }) }}
</div>
                    <div class="mt-1">Posted {{ formatDistanceToNow(parseISO(bookmark.posted_at), { addSuffix: true }) }}
</div>
                  </div>
                </div>
              </div>
...
>
                <div class="flex items-center">
                  <div class="mr-3 rounded-full bg-primary-100 p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-primary-600"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                      <path stroke-linecap="round" stroke-linejoin="round"
...
>
                <div class="flex items-center">
                  <div class="mr-3 rounded-full bg-secondary-100 p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-secondary-600"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                      <path stroke-linecap="round" stroke-linejoin="round"
stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"
...
/>
              ...
              <router-link v-if="!isPremium" to="/subscription"
...
>
                <div class="flex items-center">
                  <div class="mr-3 rounded-full bg-accent-100 p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4 text-accent-600"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                      <path stroke-linecap="round" stroke-linejoin="round"
stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"
