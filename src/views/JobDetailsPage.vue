...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div v-if="loading" class="flex items-center justify-center py-16">
      <svg xmlns="http://www.w3.org/2000/svg" class="size-10 animate-spin text-primary-500" fill="none"
    ...
    <div v-else-if="!job" class="rounded-lg bg-white p-8 text-center shadow">
      <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 size-12 text-error-500" fill="none"
        viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div v-else>
      ...
      <div class="mb-6">
        <button class="flex items-center text-primary-600 transition-colors duration-200 hover:text-primary-700"
          @click="router.back()">
          <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 size-5" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
      ...
      <div v-if="jobFreshnessAlert" class="mb-6">
        ...
        <div v-if="jobFreshnessAlert.type === 'error'" class="rounded-md border border-red-200 bg-red-50 p-4">
          <div class="flex">
            <div class="shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-red-400" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
          ...
          <div class="flex flex-col md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <div class="flex items-center text-sm text-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 size-4 text-gray-400" fill="none"
                  viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6 flex space-x-4 md:mt-0">
              <button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 size-5" :class="isSaved ? 'fill-current text-primary-500' : 'text-gray-400'
                  " viewBox="0 0 24 24" stroke="currentColor" :fill="isSaved ? 'currentColor' : 'none'">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <button v-if="canTurboApply"
                ...
                @click="openTurboApply" @mouseenter="handleTurboApplyHover" @mouseleave="handleTurboApplyLeave">
              ...
              <button
                ...
                @click="applyToJob">
                <svg class="mr-2 size-4" fill="currentColor" id="Layer_1" version="1.1"
                ...
                Snail Apply
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 size-4" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="bg-gray-50 p-6 sm:p-8">
          ...
          <div v-if="!isPremium && isAuthenticated" class="mt-4 rounded-md border border-accent-100 bg-accent-50 p-4">
            <div class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 mt-0.5 size-5 shrink-0 text-accent-500" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
      ...
      <!-- Turbo Apply Modal -->
      <TurboApplyModal v-if="showTurboApplyModal && job" :show="showTurboApplyModal" :job="job"
        :requisition-id="jobsStore.getCurrentJobId()" :ats-source="jobsStore.getCurrentJobAts()"
