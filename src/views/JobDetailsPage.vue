...
class="flex items-center justify-center py-16">
      <svg xmlns="http://www.w3.org/2000/svg" class="size-10 animate-spin text-primary-500"
...
class="rounded-lg bg-white p-8 text-center shadow">
      <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 size-12 text-error-500"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
        <path stroke-linecap="round" stroke-linejoin="round"
...
/>
      ...
      <router-link
to="/search" class="btn-primary"> Browse Jobs </router-link>
    </div>
    ...
    <div v-else>
      <!-- Back Button -->
      <div class="mb-6">
        <button class="flex items-center text-primary-600 transition-colors duration-200 hover:text-primary-700"
@click="router.back()"
>
          <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 size-5"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
...
stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
      ...
      <div v-if="jobFreshnessAlert"
class="mb-6">
        <!-- Error Alert (2+ weeks old) -->
        <div v-if="jobFreshnessAlert.type === 'error'"
class="rounded-md border border-red-200 bg-red-50 p-4">
          <div class="flex">
            <div class="shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-red-400"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                <path stroke-linecap="round" stroke-linejoin="round"
stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"
/>
        ...
        <div v-if="jobFreshnessAlert.type === 'warning'"
...
/>
            ...
            <div class="mt-6 flex space-x-4 md:mt-0">
              <button
                ...
                @click="toggleSave"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 size-5"
:class="isSaved ? 'text-primary-500 fill-current' : 'text-gray-400'" viewBox="0 0 24 24" stroke="currentColor" :fill="isSaved ? 'currentColor' : 'none'"
>
                  <path stroke-linecap="round" stroke-linejoin="round"
...
/>
              ...
              <button
                ...
                @click="applyToJob"
              >
                <svg class="mr-2 size-4" fill="currentColor"
id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve"
>
                  <g>
                    <g>
                      <path
                ...
                Snail Apply
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 size-4"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                  <path stroke-linecap="round" stroke-linejoin="round"
...
class="mr-2 size-4" fill="currentColor" viewBox="0 0 24 24">
                <path
...
/>
          ...
          <div v-if="!isPremium && isAuthenticated"
class="mt-4 rounded-md border border-accent-100 bg-accent-50 p-4">
            <div class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 mt-0.5 size-5 shrink-0 text-accent-500"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                <path stroke-linecap="round"
stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
              ...
              <div>
                <p class="text-sm text-gray-700"><span class="font-medium">Want to stand out?</span> Premium members get their applications processed faster.
</p>
...
Upgrade for $10/month
      ...
      <!-- Turbo Apply Modal -->
      <TurboApplyModal v-if="showTurboApplyModal && job" :show="showTurboApplyModal"
:job="job" :requisition-id="getRequisitionId || 0" :ats-source="job.navigation?.atsType || 'bamboo'" @close="closeTurboApply"
/>
    </div>
  </div>
</template>
