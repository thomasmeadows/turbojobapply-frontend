...
const handleSubmit = async () => {
  ...
  try {
    const success = await authStore.register(null, email.value, password.value);
        ...
        <form class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <div class="flex items-center">
            ...
            <label for="agree-terms" class="ml-2 block text-sm text-gray-900">
              I agree to the
              <router-link to="/terms-of-service" class="font-medium text-primary-600 hover:text-primary-500">terms and conditions</router-link>
            </label>
          </div>
