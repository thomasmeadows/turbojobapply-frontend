    ...
    <section class="relative bg-gradient-to-r from-primary-600 to-primary-700 text-white">
      ...
      <div class="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div class="mx-auto max-w-3xl text-center">
          <h1 class="mb-6 text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Find Your Dream Job Today
</h1>
          <p class="mb-10 text-xl text-primary-100 sm:text-2xl">Search thousands of jobs with powerful filters and find your next career opportunity
</p>
...
class="sr-only">Search</label>
                <input id="search" v-model="jobsStore.query"
type="text" class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none" placeholder="Job title"
/>
                <div class="grid shrink-0 grid-cols-1 focus-within:relative">
                  <label for="remote"
class="sr-only">Remote</label>
                  <select
                    id="remote"
...
mode="out-in">
                <p v-if="isVisible && facts[currentFactIndex] && facts[currentFactIndex].value > 0"
:key="currentFactIndex" class="scale-fade-text"
>
...
viewBox="0 0 1440 120" class="h-auto w-full">
    ...
    <section class="bg-white py-16 lg:py-24">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-12 text-center">
          ...
          <p class="mx-auto max-w-3xl text-xl text-gray-600">Turbo Job Apply helps you discover opportunities aligned with your skills and career goals
</p>
        </div>
...
/>
            ...
            <p class="text-gray-600">Filter jobs by creation date, location, industry, and more to find exactly what you're looking for.
</p>
          </div>
...
/>
            ...
            <p class="text-gray-600">Bookmark job opportunities to revisit later and keep track of your applications.
</p>
          </div>
...
class="text-gray-600"
>
All premium features are <span class="font-bold text-accent-600">FREE</span> during our beta testing phase! Enjoy one-click applications and automated job searching.
</p>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="items-center lg:grid lg:grid-cols-2 lg:gap-12">
          <div>
            ...
            <p class="mb-4 text-lg text-white">During our alpha & beta testing phase, all premium features are completely <span class="font-bold">FREE</span>!
</p>
            <p class="mb-8 text-lg text-white">Take advantage of our powerful tools to supercharge your job search before we implement our regular pricing after beta.
</p>
            <div class="space-y-4">
              <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 size-6 shrink-0 text-white"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                  <path stroke-linecap="round"
stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                <p class="text-white"><span class="font-medium">Turbo Job Apply</span> - Apply to jobs with one click
</p>
              </div>
              <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 size-6 shrink-0 text-white"
...
stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                ...
                <p class="text-white"><span class="font-medium">AI Job Apply</span> - Use AI to enhance resume's and cover's before submitting them
</p>
              </div>
              <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 size-6 shrink-0 text-white"
...
stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                ...
                <p class="text-white"><span class="font-medium">Auto Job Apply</span> - Set criteria and let us apply for you
</p>
              </div>
              <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 size-6 shrink-0 text-white"
...
stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                ...
                <p class="text-white"><span class="font-medium">Job Tracking</span> - Track application status and follow-ups
</p>
              </div>
            </div>
            <div class="mt-10">
            ...
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
              <div class="py-4 text-center">
                ...
                <div class="mb-4 rounded-lg border border-accent-200 bg-accent-50 p-3">
                  <p class="text-sm text-accent-700">Limited Time Offer: All Premium Features Free During Beta Testing
</p>
                </div>
              </div>
              <div class="mb-6 space-y-4">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 size-5 text-accent-500"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                    <path stroke-linecap="round"
stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
...
to="/subscription" class="btn-primary block w-full py-2 text-center"
>
Sign Up Free
</router-link>
              <router-link v-else
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <div class="mx-auto mb-6 flex size-16 items-center justify-center rounded-full bg-white/20">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-8 text-white"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
              <path stroke-linecap="round" stroke-linejoin="round"
...
/>
          ...
          <p class="mx-auto mb-8 max-w-3xl text-lg text-green-100">You have full access to all premium features during our beta testing phase. Start using your advanced job search tools to find your perfect opportunity.
</p>
          <div class="mb-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-lg bg-white/10 p-4">
              <div class="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-2 size-8"
fill="none" viewBox="0 0 24 24" stroke="currentColor"
>
                  <path stroke-linecap="round" stroke-linejoin="round"
...
>
                  <path stroke-linecap="round" stroke-linejoin="round"
stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4"
/>
                </svg>
...
>
                  <path stroke-linecap="round" stroke-linejoin="round"
stroke-width="2" d="M15 17h5l-5 5v-5zM4 12h16M4 18h16"
/>
                </svg>
...
Start Job Search
    ...
    <section class="bg-white py-16 lg:py-24">
      <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <p class="mx-auto mb-10 max-w-3xl text-xl text-gray-600">Join thousands of professionals who found their perfect career match with Turbo Job Apply
</p>
        <div class="flex flex-col justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
          <router-link
to="/search" class="btn-primary"> Start Searching </router-link>
          <router-link
v-if="!isAuthenticated" to="/subscription" class="btn-outline"> Create Account </router-link>
          <router-link
v-else-if="!isPremium" to="/subscription" class="btn-outline"> Get Premium Access </router-link>
          <router-link
v-else to="/dashboard" class="btn-outline"> Go to Dashboard </router-link>
        </div>
      </div>
    </section>
  </div>
