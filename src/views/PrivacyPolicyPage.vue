    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="prose prose-lg prose-primary mx-auto">
        <section>
          <h2>Introduction</h2>
          <p>
            At Turbo Job Apply, we respect your privacy and are committed to
            protecting your personal data. This Privacy Policy explains how we
            collect, use, process, and store your information when you use our
            services, and outlines your privacy rights under applicable laws,
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              number, postal address, and other similar identifiers.
            </li>
            <li>
              <strong>Account Information:</strong> Username, password, account
              preferences, and account activity.
            </li>
            <li>
              <strong>Professional Information:</strong> Employment history,
              education, skills, certifications, and other resume/CV
              information.
            </li>
            <li>
              <strong>Application Data:</strong> Information about job
              applications submitted through our platform, including application
              status.
            </li>
            <li>
              <strong>Technical Information:</strong> IP address, browser type,
              device information, operating system, and other technology
              identifiers on the devices you use to access our platform.
            </li>
            <li>
              <strong>Usage Data:</strong> Information about how you use our
              website and services, including page views, clicks, and
              interactions.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Legal Compliance:</strong> Where processing is necessary
        ...
        <section>
          ...
          <p>
            Under the GDPR and other applicable privacy laws, you have certain
            rights regarding your personal data. These rights include:
          </p>
          <ul>
            <li>
              <strong>Right to Access:</strong> You have the right to request
              information about the personal data we hold about you and to
            ...
            <li>
              ...
              have the right to request that we delete your personal data in
              certain circumstances, such as when the data is no longer
              necessary for the purposes for which it was collected, when you
              withdraw consent, or when you object to processing based on
              legitimate interests and there are no overriding legitimate
              grounds.
            </li>
            <li>
            ...
            <li>
              ...
              including processing based on legitimate interests or for direct
              marketing purposes.
            </li>
            <li>
          ...
          <p>
            ...
            30 days. In certain circumstances, we may ask for identity
        ...
        <section>
          ...
          <p>
            To request erasure of your personal data (also known as the "right
            to be forgotten"), you can contact us through the methods listed in
            the "Contact Information" section. Your request should include:
          </p>
          <ul>
            <li>
          ...
          <ol>
            ...
            <li>
              Process your erasure request within 30 days (unless there is a
              legitimate reason for extension)
            </li>
            <li>Provide confirmation once the erasure has been completed</li>
          </ol>
          <p>
            Please note that we may need to retain certain information for legal
            or compliance purposes, such as records of transactions for tax
            requirements or information needed to resolve disputes. We will
            inform you if this applies to your erasure request.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            measures to secure your personal data from accidental loss and
          ...
          <p>
            ...
            of electronic storage is 100% secure. We cannot guarantee its
            absolute security.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            the potential risk of harm from unauthorized use or disclosure, the
        ...
        <section>
          ...
          <p>
            ...
            Economic Area (EEA), we will ensure that appropriate safeguards are
            in place to protect your personal data, such as Standard Contractual
            Clauses approved by the European Commission or binding corporate
            rules.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            on our platform and to hold certain information. Cookies are files
        ...
        <section>
          ...
          <p>
            ...
            children under 16. If you are a parent or guardian and you are aware
        ...
        <section>
          ...
          <p>
            For EU residents, you also have the right to make a complaint to
            your local data protection authority if you are unhappy with how we
