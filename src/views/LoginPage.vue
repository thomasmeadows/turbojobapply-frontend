...
<template>
  <div class="flex min-h-screen flex-col justify-center bg-gray-50 py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <p class="mt-2 text-center text-sm text-gray-600">Enter your email and we'll send you a magic link to log in. New users will be automatically registered.
</p>
    </div>
...
viewBox="0 0 24 24" fill="#0077B5">
          ...
          <div class="text-center">
            <p class="text-sm text-gray-600">No password required! We'll send you a secure link that expires in 15 minutes. First time here? You'll be automatically registered.
</p>
          </div>
        </form>
      </div>
