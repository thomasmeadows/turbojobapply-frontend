...
const isSubscriptionActive = computed(() => {
  ...
  return (
    StripeService.isSubscriptionActive(subscriptionData.value.subscription) &&
...
<template>
  <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    >
      <svg
        class="-ml-1 mr-3 size-8 animate-spin text-accent-600"
              ...
              <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-green-700">
                  <p>
                    ...
                    premium access until {{ nextBillingDate }} ({{
                      daysRemaining
                    }}
                    days remaining).
                  </p>
            ...
            <div class="mx-auto max-w-2xl space-y-4 text-left">
              <div class="flex items-start">
                ...
                <div>
                  <p class="font-medium text-gray-900">
                    You keep premium access until {{ nextBillingDate }}
                  </p>
                  <p class="text-sm text-gray-600">
                    Continue using all premium features for the remainder of
                    your billing period
                  </p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">
                    Your subscription will not renew and you won't be charged
                    again
                  </p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">
                    You can reactivate your subscription anytime from your
                    subscription page
                  </p>
                </div>
              </div>
        ...
        <div v-else class="p-6">
          ...
          <div class="mb-8 text-center">
            ...
            <p class="mx-auto max-w-2xl text-gray-600">
              We'd hate to see you go! Your cancellation will take effect at the
              end of your current billing period, so you'll continue to have
              access to all premium features until {{ nextBillingDate }}.
            </p>
          </div>
          ...
          <div class="mb-8">
            <h3 class="mb-4 text-lg font-medium text-gray-900">
              What you'll lose after {{ nextBillingDate }}:
            </h3>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="mr-3 mt-0.5 size-5 text-red-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div class="border-t border-gray-200 pt-6">
            <div class="flex flex-col justify-center gap-3 sm:flex-row">
              ...
              >
                <svg
                  v-if="loading"
                  class="-ml-1 mr-2 size-4 animate-spin text-red-700"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
            ...
            <p class="mt-4 text-center text-xs text-gray-500">
              ...
              {{ nextBillingDate }} without losing access.
            </p>
          </div>
        </div>
      </div>
