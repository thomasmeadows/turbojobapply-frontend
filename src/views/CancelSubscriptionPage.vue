...
<template>
  <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
    <!-- Loading State -->
    <div v-if="loadingSubscription" class="flex items-center justify-center py-12">
      <svg class="-ml-1 mr-3 size-8 animate-spin text-accent-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div class="overflow-hidden rounded-lg bg-white shadow">
        ...
        <div class="border-b border-red-100 bg-red-50 px-6 py-8">
          <div class="flex items-center">
            <div class="rounded-full bg-red-100 p-3">
              <svg class="size-8 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div v-if="cancelationComplete" class="p-6">
          ...
          <div class="text-center">
            ...
            <div class="mx-auto max-w-2xl space-y-4 text-left">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">Continue using all premium features for the remainder of your billing period</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">You can reactivate your subscription anytime from your subscription page</p>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 space-y-3">
              ...
              <div class="text-center">
                <button class="text-sm text-accent-600 hover:text-accent-700" @click="router.push('/dashboard')">Continue to Dashboard</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-else class="p-6">
          ...
          <div class="mb-8 text-center">
            ...
            <p class="mx-auto max-w-2xl text-gray-600">We'd hate to see you go! Your cancellation will take effect at the end of your current billing period, so you'll continue to have access to all premium features until {{ nextBillingDate }}.</p>
          </div>
          ...
          <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 mt-0.5 size-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="border-t border-gray-200 pt-6">
            <div class="flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <button
                ...
                @click="handleCancel"
              >
                <svg v-if="loading" class="-ml-1 mr-2 size-4 animate-spin text-red-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                </svg>
            ...
            <p class="mt-4 text-center text-xs text-gray-500">You can reactivate your subscription anytime before {{ nextBillingDate }} without losing access.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-else class="py-12 text-center">
      <div class="mx-auto max-w-md">
        <svg class="mx-auto size-12 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
