...
<template>
  <div class="flex min-h-[calc(100vh-16rem)] items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md text-center">
      <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 size-16 text-gray-400"
...
/>
      ...
      <div class="flex flex-col justify-center space-y-3 sm:flex-row sm:space-x-3 sm:space-y-0">
        <button
class="btn-outline" @click="goBack">Go Back</button>
        <router-link
to="/" class="btn-primary"> Back to Home </router-link>
      </div>
    </div>
  </div>
</template>
