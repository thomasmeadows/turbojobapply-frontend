    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="prose prose-lg prose-primary mx-auto">
        ...
        <section>
          ...
          <p>Our platform is designed to work seamlessly with industry-standard Applicant Tracking Systems, ensuring that applications submitted through Turbo Job Apply can be easily imported and managed within your existing recruiting workflow.</p>

          <div class="mt-8 grid grid-cols-2 gap-6 md:grid-cols-3">
            <div class="rounded-lg bg-gray-50 p-4 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto size-12 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <p class="mt-8">We're continuously expanding our integration capabilities. If you don't see your ATS listed here, please contact us to discuss compatibility options.</p>
        </section>

        <section>
          <h2>How Our Integrations Work</h2>
          <p>Turbo Job Apply uses industry-standard APIs and data formats to ensure smooth data transfer between our platform and your ATS. When a candidate applies through our system:</p>
          <ol>
          ...
          <p>This seamless integration means you can take advantage of Turbo Job Apply's efficient application process without disrupting your existing recruitment workflow.</p>
        </section>
        ...
        <section>
          ...
          <p>Our development team can create custom integrations that connect your proprietary ATS with our platform, ensuring that applications flow smoothly into your system with all the necessary data formatting and processing.</p>
          <div class="my-6 border-l-4 border-gray-400 bg-gray-50 p-4">
            <p class="mb-0 font-medium text-gray-700">For custom ATS integration work, please contact us directly to discuss your requirements, timeline, and to receive a custom quote for development and scheduled maintenance.</p>
          </div>
        </section>
        ...
        <section class="rounded-lg bg-gray-50 p-6">
          ...
          <p>If you're interested in developing a custom integration between your proprietary ATS and Turbo Job Apply, please provide your information below and we'll contact you to discuss your requirements.</p>
          <div class="mt-6">
            <!-- Success Message -->
            <div v-if="isSubmitted" class="mb-6 rounded-md bg-green-50 p-4">
              <div class="flex">
                ...
                <div class="ml-3 flex-1">
                  ...
                  <div class="mt-4">
                    <button class="rounded-md bg-green-50 p-2 text-sm text-green-800 hover:bg-green-100" @click="closeSuccessMessage">Dismiss</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form class="space-y-4" @submit.prevent="submitForm">
              ...
              <div>
                ...
                >
                  <svg v-if="isSubmitting" class="-ml-1 mr-2 size-4 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
